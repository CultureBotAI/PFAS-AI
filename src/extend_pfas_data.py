#!/usr/bin/env python3
"""Script to extend PFAS data with PFAS-relevant bacteria and archaea from NCBI."""
...
def main():
    """Main function to extend the PFAS data tables."""
    ...
    print("Starting NCBI search for PFAS-relevant organisms...")
